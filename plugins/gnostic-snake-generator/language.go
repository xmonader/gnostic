...
type PythonLanguageModel struct{}

func NewPythonLanguageModel() *PythonLanguageModel {
	return &PythonLanguageModel{}
}

// Prepare sets language-specific properties for all types and methods.
func (language *PythonLanguageModel) Prepare(model *surface.Model) {
